...
import CosmonautAtlasCosmonautAtlasAtlas from './cosmonaut/Atlas/cosmonaut.atlas.atlas'
...
export default { 
  CosmonautAtlasCosmonautAtlasAtlas: load(CosmonautAtlasCosmonautAtlasAtlas, 'cosmonaut.atlas.atlas'),
